...
with open("agents/experiments/scraped_nn/scraped_1101_1200_model.txt", 'r') as f:
    MODEL = f.read()

with open("agents/experiments/scraped_nn/scraped_1101_1200_weights.txt", 'r') as f:
    WEIGHTS = f.read()

model_json = pickle.loads(bz2.decompress(base64.b64decode(MODEL)))
model_weights = pickle.loads(bz2.decompress(base64.b64decode(WEIGHTS)))
