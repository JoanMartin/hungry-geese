...
with open("agents/experiments/scraped_nn/scraped_1001_1100_model.txt", 'r') as f:
    MODEL = f.read()

with open("agents/experiments/scraped_nn/scraped_1001_1100_weights.txt", 'r') as f:
    WEIGHTS = f.read()
