...
with open("agents/experiments/scraped_nn/scraped_1201_2000_model.txt", 'r') as f:
    MODEL = f.read()

with open("agents/experiments/scraped_nn/scraped_1201_2000_weights.txt", 'r') as f:
    WEIGHTS = f.read()
