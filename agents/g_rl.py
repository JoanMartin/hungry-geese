...
from nn_config import MODEL_JSON_RL, MODEL_WEIGHTS_RL
from utils import calculate_last_action, center_matrix

model_json = pickle.loads(bz2.decompress(base64.b64decode(MODEL_JSON_RL)))
model_weights = pickle.loads(bz2.decompress(base64.b64decode(MODEL_WEIGHTS_RL)))
...
def agent(obs, config):
    ...
    actions, values = model.predict(input_board)
