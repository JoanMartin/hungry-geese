...
class ExperienceBuffer:
    ...
    def serialize(self, h5file):
        ...
        h5file['experience'].create_dataset('states', data=self.states, compression='gzip', compression_opts=9)
        h5file['experience'].create_dataset('actions', data=self.actions, compression='gzip', compression_opts=9)
        h5file['experience'].create_dataset('rewards', data=self.rewards, compression='gzip', compression_opts=9)
        h5file['experience'].create_dataset('advantages', data=self.advantages, compression='gzip', compression_opts=9)
